...
3. [Connecting Logs to Splunk]
4. [Reconnaissance with Nmap]
5. [Launching the Brute-Force Attack]
6. [Watching auth.log During the Attack]
7. [Confirming Logs Reached Splunk]
8. [Detection Queries in Splunk]
9. [Dashboard]
